  ...
  <div class="row g-4 align-items-start">
    <div class="col-md-4">
      {#if character.imageUrl}
        <img src={character.imageUrl} alt={character.name} class="img-fluid rounded shadow class-image" />
      {:else}
        <img src="/Platzhalter.png" alt="Platzhalter" class="img-fluid rounded shadow class-image" />
      {/if}
    </div>
      ...
      <div class="row mt-3">
        <div class="col-md-6">
          ...
          <p>
            ...
            <a href={`/classes/${character.classId}?fromCharacter=${character._id}`} class="btn-light">{character.className}</a>
          </p>
          <p>
            <strong>Spezies:</strong>
            <a href={`/species/${character.speciesId}?fromCharacter=${character._id}`} class="btn-light">{character.speciesName}</a>
          </p>
        </div>
        <div class="col-md-6">
