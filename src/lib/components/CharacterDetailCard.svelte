...
<div class="card bg-dark text-light p-4">
            ...
            <div class="row mt-3">
                <div class="col-md-6">
                    ...
                    <p>
                        ...
                        <a
                            href={`/classes/${character.classId}?fromCharacter=${character._id}`}
                            class="btn-light"
                        >
                            {character.className}
                        </a>
                    ...
                    <p>
                        ...
                        <a
                            href={`/species/${character.speciesId}?fromCharacter=${character._id}`}
                            class="btn-light"
                        >
    ...
    <div class="d-flex gap-2">
        ...
        <a href={`/characters/${character._id}/edit`} class="btn-standard"
            >Bearbeiten</a
        >
